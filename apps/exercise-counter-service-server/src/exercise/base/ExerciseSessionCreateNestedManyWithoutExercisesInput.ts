...
@InputType()
class ExerciseSessionCreateNestedManyWithoutExercisesInput {
...
export { ExerciseSessionCreateNestedManyWithoutExercisesInput as ExerciseSessionCreateNestedManyWithoutExercisesInput };
