...
@InputType()
class ExerciseSessionUpdateManyWithoutExercisesInput {
...
export { ExerciseSessionUpdateManyWithoutExercisesInput as ExerciseSessionUpdateManyWithoutExercisesInput };
