...
@InputType()
class ExerciseSessionCreateNestedManyWithoutUsersInput {
...
export { ExerciseSessionCreateNestedManyWithoutUsersInput as ExerciseSessionCreateNestedManyWithoutUsersInput };
