  ...
  test("POST /articles", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        relevantDate: CREATE_RESULT.relevantDate.toISOString(),
      ...
      .expect([
        {
          ...
          relevantDate: FIND_MANY_RESULT[0].relevantDate.toISOString(),
  ...
  test("GET /articles/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        relevantDate: FIND_ONE_RESULT.relevantDate.toISOString(),
